...
#define MyAppName "单点职校数据中心"
#define MyAppVersion "0.1"
#define MyAppPublisher "单点科技"
#define MyAppURL "https://www.dandian.net"
#define MyAppExeName "MyProg-x64.exe"
#define MyAppInstallDir "D:\MySchoolDataCenter"
#define MyAppSourceDir "D:\a\SchoolDataCenter\SchoolDataCenter"
...
OutputBaseFilename=MySchoolDataCenter-{#MyAppVersion}
Compression=lzma
...
[Run]
Filename: "{app}\readme.txt"; Description: "{cm:LaunchProgram,Readme}"; Flags: nowait postinstall skipifsilent ; Check: "1"
Filename: "{app}\InitialSetup.bat"; Description: "{cm:LaunchProgram,InitialSetup}"; Flags: waituntilterminated postinstall skipifsilent ; Check: "1"
Filename: "{app}\xampp-control.exe"; Description: "{cm:LaunchProgram,xampp-control}"; Flags: nowait postinstall skipifsilent ; Check: "1"
