...
const FaqsData: FaqsDataTypes[] = [
  {
    id: 'panel1',
    question: 'Which platforms does SchoolAI support?',
    answer:
      'Ios, Android, Chrome Extension, Web. There will be support for more browser extensions in the future.'
  },
  {
    id: 'panel2',
    question: 'What is SchoolAI?',
    active: true,
    answer: `SchoolAI is a `
  },
  {
    id: 'panel3',
    question: 'What are the subsequent development plans for SchoolAI?',
    answer:
