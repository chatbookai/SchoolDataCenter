  ...
  const requestIntervalFn = () => {
    ...
    try {
      ...
      if (requestUrl?.value) {
        ...
        const fetchFn = async () => {
          targetComponent.request.requestSQLContent['id'] = targetComponent.id;
          targetComponent.request.requestSQLContent['action'] = 'ListData';
          targetComponent.request.requestSQLContent['projectId'] = fetchRouteParamsLocation();
