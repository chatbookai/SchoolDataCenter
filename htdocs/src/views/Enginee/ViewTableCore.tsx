      ...
      axios
        ...
        .then(res => {
          if (res.data.status == "OK") {
            ...
            if(res.data.print && isMobileData==false) {
                        ...
                        {RowData && RowData.map((CellData: any, FieldArray_index: number) => {
                          ...
                          if (FieldArray.type == "input"
                            ...
                            return (
                              <Fragment key={FieldArray_index}>
                                <MUITableCell sx={{ width: '15%', whiteSpace: 'nowrap' }}>{FieldArray.label}:</MUITableCell>
                                <MUITableCell sx={{ width: '35%' }} colSpan={colSpan}>{typeof CellData.Value === 'string' ? CellData.Value : FieldArray.type + " " + CellData.Value.toString()}</MUITableCell>
                              </Fragment>
                            )
                          }
