...
function 开始同步基础数据($数据库连接池)  {
  ...
  if($db_remote->databaseName!="") {
      ...
      $sql = "select `td_houqin`.`edu_jifen_banji_function`.`编号` AS `id`,`td_houqin`.`edu_jifen_banji_function`.`名称` AS `名称`,`td_houqin`.`edu_jifen_banji_function`.`描述` AS `描述`,`td_houqin`.`edu_jifen_banji_function`.`排序号` AS `排序号`,`td_houqin`.`edu_jifen_banji_function`.`涉及数据` AS `涉及数据`,`td_houqin`.`edu_jifen_banji_function`.`最近更新` AS `最近更新`,`td_houqin`.`edu_jifen_banji_function`.`数据表名称` AS `数据表`,`td_houqin`.`edu_jifen_banji_function`.`SQL名称` AS `SQL名称`,`td_houqin`.`edu_jifen_banji_function`.`类型字段` AS `类型字段`,`td_houqin`.`edu_jifen_banji_function`.`类型的值` AS `类型的值`,`td_houqin`.`edu_jifen_banji_function`.`最近更新` AS `创建人`,`td_houqin`.`edu_jifen_banji_function`.`最近更新` AS `创建时间` from `td_houqin`.`edu_jifen_banji_function`";
      清空原有表并按原结构复制所有数据($数据表="data_deyu_banji_function", $sql);

      $sql = "select `td_houqin`.`edu_jifen_banji_gradeone`.`编号` AS `id`,`td_houqin`.`edu_jifen_banji_gradeone`.`名称` AS `名称`,`td_houqin`.`edu_jifen_banji_gradeone`.`描述` AS `描述`,`td_houqin`.`edu_jifen_banji_gradeone`.`最高分值` AS `最高分值`,`td_houqin`.`edu_jifen_banji_gradeone`.`最低分值` AS `最低分值`,`td_houqin`.`edu_jifen_banji_gradeone`.`排序号` AS `排序号`,`td_houqin`.`edu_jifen_banji_gradeone`.`图标` AS `图标`,`td_houqin`.`edu_jifen_banji_gradeone`.`颜色` AS `颜色` from `td_houqin`.`edu_jifen_banji_gradeone`";
      清空原有表并按原结构复制所有数据($数据表="data_deyu_banji_gradeone", $sql);

      $sql = "select `td_houqin`.`edu_jifen_banji_gradetwo`.`编号` AS `id`,`td_houqin`.`edu_jifen_banji_gradetwo`.`一级指标` AS `一级指标`,`td_houqin`.`edu_jifen_banji_gradetwo`.`二级指标` AS `二级指标`,`td_houqin`.`edu_jifen_banji_gradetwo`.`备注` AS `备注`,`td_houqin`.`edu_jifen_banji_gradetwo`.`排序号` AS `排序号`,`td_houqin`.`edu_jifen_banji_gradetwo`.`备注` AS `创建人`,`td_houqin`.`edu_jifen_banji_gradetwo`.`备注` AS `创建时间` from `td_houqin`.`edu_jifen_banji_gradetwo`";
      清空原有表并按原结构复制所有数据($数据表="data_deyu_banji_gradetwo", $sql);

      $sql = "select `td_houqin`.`edu_jifen_banji_gradethree`.`编号` AS `id`,`td_houqin`.`edu_jifen_banji_gradethree`.`二级指标` AS `一级指标`,`td_houqin`.`edu_jifen_banji_gradethree`.`二级指标` AS `二级指标`,`td_houqin`.`edu_jifen_banji_gradethree`.`积分项目` AS `积分项目`,`td_houqin`.`edu_jifen_banji_gradethree`.`积分编码` AS `积分编码`,`td_houqin`.`edu_jifen_banji_gradethree`.`积分分值` AS `积分分值`,`td_houqin`.`edu_jifen_banji_gradethree`.`排序号` AS `排序号`,`td_houqin`.`edu_jifen_banji_gradethree`.`管理人员列表` AS `管理人员`,`td_houqin`.`edu_jifen_banji_gradethree`.`备注` AS `是否班主任录入`,`td_houqin`.`edu_jifen_banji_gradethree`.`数据来源` AS `数据来源`,`td_houqin`.`edu_jifen_banji_gradethree`.`备注` AS `备注`,`td_houqin`.`edu_jifen_banji_gradethree`.`备注` AS `创建人`,`td_houqin`.`edu_jifen_banji_gradethree`.`备注` AS `创建时间`,`td_houqin`.`edu_jifen_banji_gradethree`.`备注` AS `是否班主任审核`,`td_houqin`.`edu_jifen_banji_gradethree`.`备注` AS `是否学工审核`,`td_houqin`.`edu_jifen_banji_gradethree`.`备注` AS `是否系部审核`,`td_houqin`.`edu_jifen_banji_gradethree`.`备注` AS `是否学校审核` from `td_houqin`.`edu_jifen_banji_gradethree`";
      清空原有表并按原结构复制所有数据($数据表="data_deyu_banji_gradethree", $sql);

      $sql = "select `td_houqin`.`edu_jifen_banji_record`.`编号` AS `id`,`td_houqin`.`edu_jifen_banji_record`.`学期名称` AS `学期`,`td_houqin`.`edu_jifen_banji_gradetwo`.`一级指标` AS `一级指标`,`td_houqin`.`edu_jifen_banji_record`.`二级指标` AS `二级指标`,`td_houqin`.`edu_jifen_banji_record`.`班级` AS `班级`,`td_houqin`.`edu_jifen_banji_record`.`积分项目` AS `积分项目`,`td_houqin`.`edu_jifen_banji_record`.`积分编码` AS `积分编码`,`td_houqin`.`edu_jifen_banji_record`.`积分分值` AS `积分分值`,`td_houqin`.`edu_jifen_banji_record`.`积分原因` AS `积分原因`,`td_houqin`.`edu_jifen_banji_record`.`积分时间` AS `积分时间`,`td_houqin`.`edu_jifen_banji_record`.`备注` AS `备注`,`td_houqin`.`edu_jifen_banji_record`.`附件` AS `附件`,`td_houqin`.`edu_jifen_banji_record`.`创建人` AS `创建人`,`td_houqin`.`edu_jifen_banji_record`.`创建时间` AS `创建时间`,`td_houqin`.`edu_jifen_banji_record`.`数据录入` AS `数据录入`,`td_houqin`.`edu_jifen_banji_record`.`创建时间` AS `班主任审核时间`,`td_houqin`.`edu_jifen_banji_record`.`院系审核状态` AS `系部审核状态`,`td_houqin`.`edu_jifen_banji_record`.`创建时间` AS `系部审核时间`,`td_houqin`.`edu_jifen_banji_record`.`院系审核人` AS `系部审核人`,`td_houqin`.`edu_jifen_banji_record`.`院系审核状态` AS `系部审核意见`,`td_houqin`.`edu_jifen_banji_record`.`学工审核状态` AS `学工审核状态`,`td_houqin`.`edu_jifen_banji_record`.`创建时间` AS `学工审核时间`,`td_houqin`.`edu_jifen_banji_record`.`学工审核人` AS `学工审核人`,`td_houqin`.`edu_jifen_banji_record`.`学工审核状态` AS `学工审核意见`,`td_houqin`.`edu_jifen_banji_record`.`校级审核状态` AS `学校审核状态`,`td_houqin`.`edu_jifen_banji_record`.`创建时间` AS `学校审核时间`,`td_houqin`.`edu_jifen_banji_record`.`校级审核人` AS `学校审核人`,`td_houqin`.`edu_jifen_banji_record`.`校级审核状态` AS `学校审核意见` from (`td_houqin`.`edu_jifen_banji_record` join `td_houqin`.`edu_jifen_banji_gradetwo`) where (`td_houqin`.`edu_jifen_banji_gradetwo`.`二级指标` = `td_houqin`.`edu_jifen_banji_record`.`二级指标`)";
      清空原有表并按原结构复制所有数据($数据表="data_deyu_banji_record", $sql);
