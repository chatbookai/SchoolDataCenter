...
//按一级指标统计积分
$sql = "select 一级指标 AS title, Count(积分分值) AS NUM from data_deyu_geren_record where 学号='$学号' $whereSql group by 一级指标 order by 一级指标 asc";
$rs = $db->Execute($sql);
$rs_a = $rs->GetArray();
$Item = [];
$data = [];
...
$ApexAreaChart['Title']       = "我的积分之和";
$ApexAreaChart['SubTitle']    = "按天统计我的积分之和";
...
$ApexLineChart['Title']         = "我的积分之和";
$ApexLineChart['SubTitle']      = "按天统计我的积分之和";
...
$AnalyticsWeeklyOverview['Title']         = "个人积分周报";
$AnalyticsWeeklyOverview['SubTitle']      = "最近一周我的积分之和";
...
$AnalyticsWeeklyOverview['BottomText']['Left']      = $最近一周总积分为;
$AnalyticsWeeklyOverview['BottomText']['Right']     = "最近一周总积分为".$最近一周总积分为.", 比上周增加13%";
...
$AnalyticsPerformance['SubTitle']    = "按一级指标统计我的积分之和";
